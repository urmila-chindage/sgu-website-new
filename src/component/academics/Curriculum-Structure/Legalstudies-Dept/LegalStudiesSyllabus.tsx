...
import LegalStudies1 from './LegalStudies1';

const LegalStudiesSyllabus = () => {
  return (
    ...
    <Tab.Container id="myTab" defaultActiveKey="overview-tab">
      <Nav className="nav-tabs tl-course-details-navs">
        <Nav.Item>
          <Nav.Link eventKey="overview-tab">Legal Studies</Nav.Link>
        </Nav.Item>
      </Nav>
...
export default LegalStudiesSyllabus