...
import AllFirstYear from './AllFirstYear';

const AllFirstYearSyllabus = () => {
  return (
    ...
    <Tab.Container id="myTab" defaultActiveKey="overview-tab">
      <Nav className="nav-tabs tl-course-details-navs">
        <Nav.Item>
          <Nav.Link eventKey="overview-tab">First Year Structure</Nav.Link>
        </Nav.Item>
      </Nav>
...
export default AllFirstYearSyllabus