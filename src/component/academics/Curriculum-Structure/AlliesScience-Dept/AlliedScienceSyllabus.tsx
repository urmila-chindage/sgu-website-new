...
import BscFoodScience from './BscFoodScience';
import BscMedicalLaboratory from './BscMedicalLaboratory';

const AlliedScienceSyllabus = () => {
  return (
    ...
    <Tab.Container id="myTab" defaultActiveKey="overview-tab">
      <Nav className="nav-tabs tl-course-details-navs">
        <Nav.Item>
          <Nav.Link eventKey="overview-tab">B.Sc. Food Science and Technology</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="curriculum-tab">B.Sc. Medical Laboratory Technology</Nav.Link>
        </Nav.Item>
...
export default AlliedScienceSyllabus