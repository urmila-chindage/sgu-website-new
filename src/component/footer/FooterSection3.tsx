                    ...
                    <div className="col-lg-4 col-sm-6 col-12">
                        <div className="tl-footer-widget tl-3-footer-widget">
                            ...
                            <ul className="tl-footer-links tl-3-footer-contact-infos">
                                ...
                                <li>
                                    <p className="tl-3-footer-address">Sanjay Ghodawat University,Kolhapur - Sangli Highway,A/p Atigre - 416 118,Tal. - Hatkanangale,Dist. - Kolhapur,Maharashtra, India</p>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="container">
                <div className="row gy-4 align-items-center">
                    <div className="col-md-6">
                        <p className="tl-3-copyright-txt m-0 text-center text-md-start">Copyright © 2024 All Rights Reserved by Enark</p>
                    </div>
