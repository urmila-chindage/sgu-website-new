           ...
           <div className="accordion mt-20" id="accordionExample">
              <div className="tl-event-details-area tl-course-details-curriculum">
                ...
                >
                  ...
                  <h3 className="accordion-table-title">B.Design Academic Year 2024-25</h3>
              ...
              <div className="tl-event-details-area tl-course-details-curriculum">
                ...
                >
                  <div className="accordion-body">
                  <h3 className="accordion-table-title">B.Arch Academic Year 2020-21</h3>
                <Table striped bordered responsive className="governing-table">
                    <thead>
                        <tr>
                            <th><p>Course Name</p></th>
              ...
              <div className="tl-event-details-area tl-course-details-curriculum">
                ...
                >
                  <div className="accordion-body">
                  <h3 className="accordion-table-title">B.Arch Academic Year 2018-19</h3>
                <Table striped bordered responsive className="governing-table">
                    <thead>
                        <tr>
                            <th><p>Course Name</p></th>
