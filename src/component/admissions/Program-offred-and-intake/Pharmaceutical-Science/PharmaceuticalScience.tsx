...
const PharmaceuticalScience = () => {
  return (
    <div className="schools-section pt-50 pb-50">
    <div className="container">
    <div className="row">
    <h2 className="universityobject-heading dark-mode-white-color">Programmes Offered Under School of Pharmaceutical Sciences</h2>
    ...
    <Tab.Container id="myTab" defaultActiveKey="overview-tab">
      ...
      <Nav.Item>
          <Nav.Link eventKey="diploma-tab">Diploma Programmes</Nav.Link>
        </Nav.Item>
        <Nav.Item>
...
export default PharmaceuticalScience