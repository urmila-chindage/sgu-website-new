...
const LegalStudies = () => {
  return (
    ...
    <div className="row">
    <h2 className="universityobject-heading dark-mode-white-color">Programmes Offered Under School of Legal Studies (Law)</h2>
    ...
    <Tab.Container id="myTab" defaultActiveKey="overview-tab">
      <Nav className="nav-tabs tl-course-details-navs">
        ...
        <Nav.Item>
          <Nav.Link eventKey="phdprograms-tab">Ph.D. programmes</Nav.Link>
        </Nav.Item>
        <Nav.Item>
      ...
      <Tab.Content id="tl-course-tab-content">
        ...
        <Tab.Pane eventKey="phdprograms-tab">
         <PhdPrograms/>
        </Tab.Pane>
