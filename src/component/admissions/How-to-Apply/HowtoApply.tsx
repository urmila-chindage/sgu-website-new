                    ...
                    <div className="tl-event-details-left">
                        <div className="tl-event-details-key-content tl-event-details-area">
                               <ul className="tl-event-details-key-content-list phd-container">
                                    <li><strong>OPTION 1</strong> : For Information Call us on +91 90110 39800, +91 90110 22567</li>
                                    
                                    <li><strong>OPTION 2</strong> : Visit our Admission cell, Sanjay Ghodawat University, Kolhapur - Sangli Highway, A/p Atigre - 416 118,
                                        <br/>Tal. - Hatkanangale, Dist. Kolhapur, Maharashtra, India</li>
